...
class Handler(http.server.SimpleHTTPRequestHandler):
    ...
    def translate_path(self, path):
        ...
        if clean in ("/dungeon", "/dungeon.html"):
            return os.path.join(ROOT, "dungeon.html")
    ...
    def send_head(self):
        ...
        if os.path.basename(path) in ("index.html", "game.html", "dungeon.html") and os.path.isfile(path):
