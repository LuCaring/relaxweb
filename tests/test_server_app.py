...
class ApplicationTests(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_route_contract_is_complete(self):
        expected = """register login resume logout update_profile get_profile delete_account get_online
            ...
            dungeon_control dungeon_get_result dungeon_use_currency
            dungeon_affix_probabilities
            ...
            dungeon_beta_start_run dungeon_beta_take_control dungeon_beta_resume
            dungeon_beta_pause dungeon_beta_abandon dungeon_beta_input dungeon_beta_sync"""
        self.assertEqual(set(self.app.handlers), set(expected.split()))
        self.assertEqual(len(self.app.handlers), 93)
