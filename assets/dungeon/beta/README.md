...
- `enemies/cave_bat/` and `enemies/stone_brute/`: each action sheet is 2172 × 724, six frames of 362 × 724. `frames.json` records the four actions. The source frames contain generous transparent padding. The stone brute uses a temporary procedural step sway until a dedicated move sheet is supplied.
